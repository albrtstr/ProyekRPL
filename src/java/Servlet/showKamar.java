...
public class showKamar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet showKamar</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet showKamar at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//                case "kelolaAkun":
//                    String queryakun = "select * from customer";
//                    //   Statement statement = conn.getConnection().createStatement();
//                    // ResultSet result = statement.executeQuery(queryakun);
//                    out.print("<html>");
//                    out.print("<body>");
//                    out.print("<center> <h1> CUSTOMER ARIA ROOM AND SWIMMING POOL </h1> <table border=3>");
//                    out.print("<tr>");
//                    out.print("<td>ID Customer</td>");
//                    out.print("<td>Nama Customer</td>");
//                    out.print("<td>Username Customer</td>");
//                    out.print("<td>Alamat Customer</td>");
//                    out.print("<td>Nomor Telepon Customer</td>");
//                    out.print("</tr>");
////            while (result.next()) {
////                out.print("<tr>");
////                out.print("<td>" + result.getString(1) + "</td>");
